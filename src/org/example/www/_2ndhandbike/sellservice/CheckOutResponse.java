...
/**
 * CheckOutResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class CheckOutResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.example.org/2ndHandBike/SellService/", "checkOutResponse", "ns2");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":checkOutResponse", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "checkOutResponse",
						xmlWriter);
			}
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"checkOutResponse".equals(type)) {
							...
							return (CheckOutResponse) org.example.www._2ndhandbike.sellservice.ExtensionMapper
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "result").equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
						...
						object.setResult(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(content));
