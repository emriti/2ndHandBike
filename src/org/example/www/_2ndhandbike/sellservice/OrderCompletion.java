...
/**
 * OrderCompletion bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class OrderCompletion implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.example.org/2ndHandBike/SellService/", "orderCompletion", "ns2");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":orderCompletion", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "orderCompletion",
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static OrderCompletion parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			OrderCompletion object = new OrderCompletion();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"orderCompletion".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (OrderCompletion) org.example.www._2ndhandbike.sellservice.ExtensionMapper
